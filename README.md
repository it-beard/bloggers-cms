...
- Возможность вести учёт нескольких Брендов в рамках одног оинтерфейса
   - Под "Брендом" мы понимаем сущность, к которой привязывается контент, участники контента, доходы и расходы. Это может быть отдельный YT-канал, блогер, проект, компания и т.д.
