...
_Миграция базы данных произойдет автоматически при первом запуске проекта `Pds.Api`._
...
1. По умолчанию, [аутентификация Auth0](https://auth0.com/) **отключена**.
...
Настройки проекта находятся в файле `bloggers-cms/Pds/Pds.Api/appsettings.json`:
   - Раздел `Logging` содержит настройки ведения журнала. Значения по умолчанию, как правило, не требуют изменения.
