...
1. [Install and configure the SQL database](https://github.com/it-beard/bloggers-cms/wiki/how-to-create-db)
2. Disable Auth0 authentication
   - By default, the CMS includes [Auth0 authentication](https://auth0.com/), which requires additional [configuration](https://github.com/it-beard/bloggers-cms/wiki/Authorisation-configuration).
...
3. Configure the CMS according to the description in the "**Main Settings**" section.
4. Run the `Pds.Api` and `Pds.Web` projects
       
_The database migration will occur automatically when you first run the `Pds.Api` project._

# Docker Support

To run the application in test mode, simply enter the command:
